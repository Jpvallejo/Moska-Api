...
var firebase_service_1 = __importDefault(require("../services/firebase-service"));
var UserDatabase = /** @class */ (function () {
    ...
    UserDatabase.prototype.getUserId = function (requested) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, Object.keys(this.users).find(function (key) {
                        return _this.users[key].email === requested.email &&
                            _this.users[key].firstName === requested.firstName &&
                            _this.users[key].email === requested.lastName;
                    })];
            });
        });
    };
